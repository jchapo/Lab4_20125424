...
!function (n) {
    ...
    function yt(t) {
        ...
        for (i && (n = P("<tr/>").appendTo(r)), c = 0, f = s.length; c < f; c++) {
            ...
            i && e.appendTo(n);
            // Comentario la parte que agrega la clase de ordenación
    ...
    function u(t, e) {
        ...
        a && ie(t), n ? Rt(t, t.oAnteriorSearch) : t.aiDisplay = t.aiDisplayMaster.slice(), !0 !== e && (t._iDisplayStart = 0), t._drawHold = e, y(t), t._drawHold = !1
    }
    ...
    function At(t) {
        for (var e, n, a, r = t.aoColumns, o = r.length, i = t.oFeatures, l = t.oAnteriorSearch, s = t.aoPreSearchCols, u = [], c = I(t), f = t._iDisplayStart, d = !1 !== i.bPaginate ? t._iDisplayLength : -1, h = function (t, e) {
    ...
    function Lt(n) {
        ...
        var t = n.oClasses, a = n.sTableId, r = n.oLanguage, o = n.oAnteriorSearch, i = n.aanFeatures,
    ...
    function Rt(t, e, n) {
        ...
        var o = t.oAnteriorSearch, i = t.aoPreSearchCols;
        if (lt(t), "ssp" != E(t)) {
    ...
    function Ht(t, e, n, a, r, o) {
        var i, l, s, u = Nt(e, a, r, o), r = t.oAnteriorSearch.sSearch, o = t.aiDisplayMaster, c = [];
    ...
    function ee(t) {
        ...
        if (g || !h && !l && !i && s == T(t) && s == c.length) for (D = 0; D < s; D++) {
            ...
            for (var v = P("<div/>").css(l || i ? {
                ...
                var _ = P(c[D]), w = _.outerWidth() - _.width(),
    ...
    function ce(t) {
        var e, n, a, r = t.aUltimoSort, o = t.oClasses.sSortColumn, i = I(t), l = t.oFeatures;
        ...
        if (t && t.time) {
            ...
            if (-1 !== P.inArray(!1, l)) n._bLoadingState = !1; else {
                ...
                if (0 < l && t.time < +new Date - 1e3 * l) n._bLoadingState = !1; else if (t.columns && o.length !== t.columns.length) n._bLoadingState = !1; else {
                    ...
                    })), t.search !== H && P.extend(n.oAnteriorSearch, Bt(t.search)), t.columns) {
    ...
    var Ie = [], o = Array.prototype, B = function (t, e) {
        ...
        var t = this.context;
        return e === H ? 0 !== t.length ? t[0].oAnteriorSearch.sSearch : H : this.iterator("table", function (t) {
            t.oFeatures.bFilter && Rt(t, P.extend({}, t.oAnteriorSearch, {
                sSearch: e + "",
                bRegex: null !== n && n,
                bSmart: null === a || a,
        ...
        oLanguage: {
            ...
            oPaginate: {sPrimero: "Primero", sUltimo: "Ultimo", sSiguiente: "Siguiente", sAnterior: "Anterior"},
            sEmptyTable: "No hay resultados",
            sInfo: "Del _START_ al _END_ de un total de _TOTAL_ resultados",
            sInfoEmpty: "No hay resultados",
            sInfoFiltered: "(Filtrado de _MAX_ resultados)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Cantidad de resultados: _MENU_",
                    ...
                    for (var n, a = b.sPageButtonDisabled, r = function (t) {
                        ...
                        switch (p = null, g = n) {
                            case"ellipsis":
                                ...
                                break;
                            case"first":
                                p = m.sPrimero, 0 === f && (s = !0);
                                break;
                            case"previous":
                                p = m.sAnterior, 0 === f && (s = !0);
                                break;
                            case"next":
                                p = m.sSiguiente, 0 !== d && f !== d - 1 || (s = !0);
                                break;
                            case"last":
                                p = m.sUltimo, 0 !== d && f !== d - 1 || (s = !0);
                                break;
                            default:
